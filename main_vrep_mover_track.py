...
from mover.inference_track import MoveInference
import random
import numpy as np

def main():
    rob_arm = SingleRoboticArm()
    checkpoints_file_path = 'mover/ckpnt_xyz_track_curve_0620/checkpoint-best.pth'
    ...
    gripper_pose[0, 3] = hole_keypoint_bottom_pose[0, 3] + 0
    gripper_pose[1, 3] = hole_keypoint_bottom_pose[1, 3] + 0
    gripper_pose[2, 3] = hole_keypoint_bottom_pose[2, 3] + 0.12
    ...
    for i in range(60):
        ...
        r, t, step_size_t = mover.inference_single_frame(rgb=rgb, depth_mm=depth_mm)
        #t = t / np.linalg.norm(t)
        move = t * step_size_t * const_factor
        print('t',t, 'k',step_size_t,)
