...
def main():
    ...
    f = open(os.path.join(benchmark_folder, "benchmark_1226_reg_close_e_157_vision_eye_concat.txt"), "w")

    rob_arm = SingleRoboticArm()
    init_pose = rob_arm.get_object_matrix(obj_name='UR5_ikTarget')
    net_date = '2021-12-26_20-35'
    mover = PointnetMover(date=net_date, model_name='pointnet2_reg_msg', checkpoint_name='best_model_e_157.pth', use_cpu=False, out_channel=9)
