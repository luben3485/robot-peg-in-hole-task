#!/bin/sh
python depth2pcd.py --folder_path fine_insertion_square_7x12x12_2022-05-02-notilt-test --offset kpts --visualize
#python 2depth2pcd_seg_heatmap_kpt_dir.py --folder_path fine_insertion_square_2022-04-14-crop-test --offset kpts --crop_pcd --visualize
