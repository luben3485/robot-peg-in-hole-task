#! /usr/bin/env python
import mankey.network.inference_argmax as inference_argmax
...
parser.add_argument('--net_path', type=str,
                    ...
                    default='/Users/cmlab/robot-peg-in-hole-task/mankey/experiment/ckpnt_box_argmax/checkpoint-100.pth',
...
class KeypointDetection(object):
    ...
    def __init__(self, network_ckpnt_path):
        ...
        self._network, self._net_config = inference_argmax.construct_resnet_nostage(network_ckpnt_path)
    ...
    def process_raw(
        ...
        imgproc_out = inference_argmax.proc_input_img_raw(
            cv_rgb, cv_depth,
            top_left, bottom_right)
        keypointxy_depth_scaled = inference_argmax.inference_resnet_nostage(self._network, imgproc_out)
        keypointxy_depth_realunit = inference_argmax.get_keypoint_xy_depth_real_unit(keypointxy_depth_scaled)
        _, camera_keypoint = inference_argmax.get_3d_prediction(
