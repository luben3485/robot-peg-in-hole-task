...
def main():
    ...
    f = open(os.path.join(benchmark_folder, "benchmark_1015_no_kpt_reg_filter_400_2_cp_200_d_05_60.txt"), "w")
    ...
    netpath = '/Users/cmlab/robot-peg-in-hole-task/mankey/experiment/ckpnt_xyzrot_coord_small_range_1015_no_kpt_reg_filter_400_2/checkpoint-200.pth'
