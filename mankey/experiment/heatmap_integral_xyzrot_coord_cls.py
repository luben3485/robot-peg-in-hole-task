...
checkpoint_dir_name = 'ckpnt_xyzrot_coord_small_range_1023_no_kpt_cls_filter_400'
...
def construct_dataset(is_train: bool) -> (torch.utils.data.Dataset, SupervisedKeypointDatasetConfig):
    ...
    db_config.keypoint_yaml_name = 'peg_in_hole_filter_400.yaml'
    db_config.pdc_data_root = '/tmp2/r09944001/data/pdc'
    if is_train:
        db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20211023.txt'
    else:
        db_config.config_file_path = '/tmp2/r90944001/robot-peg-in-hole-task/mankey/config/insertion_20211023.txt'
