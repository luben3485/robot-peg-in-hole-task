...
class SupervisedKeypointDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if processed_entry.has_depth:
            ...
            processed_entry.cropped_depth[processed_entry.cropped_depth >= self._config.depth_image_clip] = 0
            normalized_depth = cv2.normalize(processed_entry.cropped_depth, None, alpha=0, beta=1, norm_type=cv2.NORM_MINMAX, dtype=cv2.CV_32F)
            ''' 
