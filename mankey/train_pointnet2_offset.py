...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=32, help='32batch size in training')
...
def construct_dataset(is_train: bool) -> (torch.utils.data.Dataset, SupervisedKeypointDatasetConfig):
    ...
    if is_train:
        db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20220620_fine_crop_noiseaug3_rotscale.txt'
    else:
        db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20220620_fine_crop_noiseaug3_rotscale.txt'
