...
import mankey.network.resnet_nostage_xyzrot_2 as resnet_nostage
...
def inference_resnet_nostage(
    ...
    delta_rot_pred = delta_rot_pred.cpu().detach().numpy()[0]
    delta_xyz_pred = delta_xyz_pred.cpu().detach().numpy()[0]
    step_size_pred = step_size_pred.cpu().detach().numpy()[0]

    return keypointxy_depth_pred, delta_rot_pred, delta_xyz_pred, step_size_pred
