...
class action_net_old(nn.Module):
    def __init__(self):
        super(action_net_old, self).__init__()
...
class get_model(nn.Module):
    def __init__(self,):
        ...
        self.actionnet_old = action_net_old()
    ...
    def forward(self, xyz):
        ...
        delta_xyz_pred, delta_rot_6d_pred = self.actionnet(global_features)
        
        return delta_xyz_pred, delta_rot_6d_pred
        
    def forward_old(self, xyz):
        global_features, point_features = self.backbone(xyz)
