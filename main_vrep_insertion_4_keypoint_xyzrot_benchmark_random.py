...
def main():
    ...
    f = open(os.path.join(benchmark_folder, "benchmark_1119_no_kpt_reg_cp_160_d_00_60_fix.txt"), "w")
    rob_arm = SingleRoboticArm()
    init_pose = rob_arm.get_object_matrix(obj_name='UR5_ikTarget')
    #netpath = '/Users/cmlab/robot-peg-in-hole-task/mankey/experiment/ckpnt_xyzrot_coord_small_range_1113_no_kpt_reg_filter_400/checkpoint-100.pth'
