...
def main():
    ...
    netpath = '/Users/cmlab/robot-peg-in-hole-task/mankey/experiment/ckpnt_xyzrot_0715/checkpoint-100.pth'
    ...
    start_gripper_pose = rob_arm.get_object_matrix('UR5_ikTip')
    start_gripper_pose[:3,3] += np.array([0,0,0.12])
    # gt grasp
    ...
    rob_arm.movement(start_gripper_pose)
