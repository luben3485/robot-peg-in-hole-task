...
from keypoint_detection_argmax import KeypointDetection
import numpy as np
import cv2
import math
import random
...
netpath = '/Users/cmlab/robot-peg-in-hole-task/mankey/experiment/ckpnt_box_argmax/checkpoint-100.pth'
